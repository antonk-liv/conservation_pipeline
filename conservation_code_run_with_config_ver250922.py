...
for t in all_targets:
    ...
    species_list=[] #list of all other species except target species
...
for sequence in seq_outputs: 
    ...
    if max_len < 2000: #use default settings if max sequence length is below 2000 amino acids   
        ...
        os.system(command3)
    if max_len >= 2000 and max_len <30000: #use recommended MUSCLE settings for long sequences if max sequence length is 2000 amino acids and above
        ...
        os.system(command3)
    if max_len >= 30000: #do not make MSAs if any seq is 30000 amino acids or more as they fail anyway
