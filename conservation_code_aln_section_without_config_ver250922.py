...
#Specify parameters in lines 23-26
...
#specify target amino acid and its most likely mutation (if no mutation then input any except target amino acid and ignore any "substitution" columns in output)
target_amino_acid='S' #specify your target amino_acid
sub='T' #an amino acid which acts as a common interchangeable mutation residue to the target amino acid
